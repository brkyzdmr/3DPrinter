...
#define PRINTER_NAME "TEVO Tarantula (BrkYzdmR)"  // Change this to whatever you wish, or leave it as it is.
...
#define STRING_CONFIG_H_AUTHOR "(Berkay Ezdemir, TEVO Tarantula config)" // Who made the changes.
 ...
 */
#if ENABLED(BLTOUCH) || ENABLED(SN04) || ENABLED(INDUCTIVE_NO) || ENABLED(INDUCTIVE_NC) || ENABLED(SERVO_PROBE) || ENABLED(MANUAL)
